...
var OWLFrame = exports.OWLFrame = function OWLFrame(gen, obj,type) {
    ...
    if (obj instanceof OWLObject) {
        ...
        axioms = axioms.concat(set2l(gen.getOntology().getAnnotationAssertionAxioms(obj.getIRI())));
...
OWLFrame.prototype.getOWLObjectProperty = function() {
    var iri = this.getIRI();
    return this.generator.objectProperty(iri);
}

OWLFrame.prototype.getOWLIndividual = function() {
    var iri = this.getIRI();
    return this.generator.namedIndividual(iri);
}
