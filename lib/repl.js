...
/*
  ...
  > q = intersectionOf(o.epithelial_cell, someValuesFrom(o.part_of, o.intestine))
  >
  > # iterate over subclasses showing each, using <pp>
  > owl.getInferredSubClasses(q).forEach(pp)
...
// TODO - test
var mkObjectProperty = exports.mkObjectProperty = function(args) { 
    if (typeof args == 'string') {
        args = { label: args };
    }
...
exports.mkDisjointUnion2 = function(obj, axioms) {
    var rcs = [];
    for (var k in obj) {
        var c = mkClass(k);
        var v = obj[k];
        ...
        if (v.push != null) {
            ...
            sobjs = this.mkDisjointUnion2(v, axioms);
        }
