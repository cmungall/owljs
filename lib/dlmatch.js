/* Namespace: DLMatch
 *
 * Matches Description Logic axioms and expressions to query templates.
 *
 * Example:
 ...
 *
 * A match constructor is just a means of constructing a dict; for example, this:
 * > q.subClassOfMatch( "?p", q.objectSomeValuesFromMatch(part_of, "?w"))
 * is equivalent to:
 * > {
