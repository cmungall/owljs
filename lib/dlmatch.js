 ...
 * >
 * > // finds ?p and ?w where there are axioms ?p SubClassOf: part_of some ?w
 * > var matches = q.find(
 ...
 *
 * The function rfunc is called on every matching axiom, with the first argument
 * being the bindings object.
 *
 *
 * Example:
 *
 ...
 * >    function(m,owl) { owl.propertyAssertion( m.r, owl.namedIndividual(m.x), owl.namedIndividual(m.y) ) }
 * > );
 *
 * Arguments:
 *  - q: a query template
