...
exports.getDefinitionObject = function(owl, obj) {
    ...
    if (defs.length == 0) {
        ...
        var xrefs = 
            ...
            map( function(a) { 
                var av = a.getValue();
                if (av.getLiteral != null) {
                    return av.getLiteral();
                } 
                else if (av.getIRI != null) {
                    return av.getIRI();
                }
                else {
                    return av.toString();
...
var getDbXrefAnnotations = exports.getDbXrefAnnotations = function(owl, obj) {
    return owl.getAnnotationValues(obj, hasDbXref(owl));
}

exports.getDbXrefMap = function(owl) {
    ...
    objs.forEach(function(obj) {
        ...
        m[id].push(getDbXrefAnnotations(owl, obj));
    });
    return m;
}
