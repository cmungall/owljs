 ...
 * 
 * Arguments:
 *  - iriOrOntID: (optional) a <owlapi.IRI> or a string denoting an IRI *or* an OWLOntologyID
 ...
 *  - versionIRI: an a <owlapi.IRI> or a string denoting an IRI, which is the ontology versionIRI
 *
 *
 * Returns:
