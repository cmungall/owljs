...
OWL.prototype.declare = function(obj) {
    var ax = this.getOWLDataFactory().getOWLDeclarationAxiom(obj);
    return this.add(ax);
}
 ...
 *  - filler : <owlapi.OWLClassExpression> or <owlapi.OWLDataExpression>
 *
 *
 * Returns:
 ...
 * <owlapi.OWLAxiom>
 */
//OWL.prototype.subClassOf = function () { return this.getOWLDataFactory().getOWLSubClassOfAxiom.apply(this.getOWLDataFactory(),arguments.map(javautil.toJava)) }
 ...
 * <owlapi.OWLAxiom>
 */
OWL.prototype.propertyAssertion = function (p,i,j) { 
    if (p instanceof OWLObjectPropertyExpression) {
        ...
        //return this.getOWLDataFactory().getOWLObjectPropertyAssertionAxiom(p,i,j) 
    }
    else {
        return this.factoryRequest(this.getOWLDataFactory().getOWLDataPropertyAssertionAxiom, arguments) 
        //return this.getOWLDataFactory().getOWLDataPropertyAssertionAxiom(p,i,j) 
    }
}
 ...
 *  An <OWL> object is a wrapper for an OWLOntology (see <getOntology>)
 *
 * About: OWLReasoner
 *  used to compute inferences
 *  An <OWL> object holds a single reasoner (see <getReasoner>)
 *
 ...
 *  Generated using <OWL.dataProperty> (todo)
 *
 ...
 *  Generated using <OWL.someValuesFrom> with am <owlapi.OWLObjectPropertyExpression> as first arg
 *
 * About: OWLDataSomeValuesFrom
 *  Generated using <OWL.someValuesFrom> with am <owlapi.OWLDataPropertyExpression> as first arg
 * 
 * About: IRI
 *  A web identifier for an OWL entity
 *
